...
const Footer = () => (
  <div className="footer">
    <div className="footer__icon__container">
      <a href="https://drive.google.com/file/d/1ww5Q0t17y8R1TQXjWtw12nPDXbQ3Irlr/view?usp=sharing" target="_blank" rel="noreferrer">
    ...
    <div className="footer__credit"><p>Pixel art animation made by me !</p></div>
  </div>
);
