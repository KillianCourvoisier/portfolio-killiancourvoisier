    ...
    <div className="interests__grid">
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          ...
          Rien de mieux que la musique, si elle n'existait pas, il faudrait l'inventée.
        </div>
      </div>
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          J'ai passé ma vie a déménager dû au mutations professionnelle de mes parents.
          J'aime particulièrement le côter découvertes culinaire, manger est une vrai passion également (d'ailleurs j'hésite à en faire une carte sup.)
      ...
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          Une grande passion également ! Tout m'interesse la dedans, de la conception à la mise en production,
          des scénarii aux modèles 3D/2D, des animations à toute la partie Sound Design, l'IA ... C'est un peu ce qui m'as orienté
          sur le developpement, je caresse le doux rêve de finir par pouvoir enfin dire un jour : "j'ai créer un jeu vidéo !".
        </div>
      </div>
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          Et tout ce que ça implique également. Je suis fasciné par notre capacité a hériger de tel structures depuis toujours.
          J'englobe ici l'ingénieurie civil en général, les ponts, les routes, l'urbanisme ancien ou actuel.
          Les solutions que l'on as su développer face à des contraintes très spécifique, la pérénité de certaines, le style d'autres...
      ...
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          Un peu comme pour l'Architecture, tout les plans des sciences suscite chez moi une curiosté.
      ...
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          ...
          Et quand on s'intéresse à l'Histoire, on se rend compte des liens, du passé, et d'où on viens.
          Les chemins empruntés , les contextes d'époque, nous rappel que les temps change et nous permettent de prendre
          du recule sur nos connaissances. C'est important pour se comprendre soi-même, et comprendre les autres et le monde.
      ...
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          ...
          Avec un faible pour celui des années 80/90, on va pas se mentir. Et puis les chefs-d'oeuvre un peu plus tardifs,
      ...
      <div className="grid__items">
        ...
        <div className="grid__items__content">
          ...
          Parce que l'IA, c'est ouf et ça peux toucher a tout ce que j'ai citer à côter. Alors oui , l'IA, parce que.(っ▀¯▀)つ
        </div>
      </div>
    </div>
  </div>
